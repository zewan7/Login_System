...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        widget.resize(326, 290)
        widget.setMinimumSize(QSize(326, 290))
        widget.setMaximumSize(QSize(326, 339))
        icon = QIcon()
        ...
        self.lineEdit_account.setFont(font1)
        self.lineEdit_account.setEchoMode(QLineEdit.Normal)
        ...
        self.checkBox_aoto_login.setFont(font2)
        ...
        self.checkBox_remember.setFont(font2)
        ...
        self.pushButton_register.setFont(font3)
        ...
        self.pushButton_fpwd.setFont(font3)
